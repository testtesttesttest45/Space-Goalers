  ...
  public partial class QuantumMenuGraphicsSettings {
    ...
    protected static int[] PossibleFramerates = new int[] { -1, 30, 60, 75, 90, 120, 144, 165, 240, 360 };
        ...
        public virtual int Framerate
        {
            get
            {
                // Mobile default = 60. Desktop keeps platform default (-1).
                int defaultFps = Application.isMobilePlatform ? 60 : -1;
                var f = PlayerPrefs.GetInt("Photon.Menu.Framerate", defaultFps);
        ...
        {
            // Default OFF (0). Don’t inherit whatever vSyncCount currently is.
            get => PlayerPrefs.GetInt("Photon.Menu.VSync", 0) == 1;
