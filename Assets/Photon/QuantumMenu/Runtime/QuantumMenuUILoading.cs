    ...
    public override void Init() {
      ...
      InitUser();
        ...
        public override void Show()
        {
            ...
            if (_text != null)
                _text.text = "";   // reset old text

            if (_disconnectButton != null)
            {
                _disconnectButton.onClick.RemoveListener(OnDisconnectPressed);
                _disconnectButton.onClick.AddListener(OnDisconnectPressed);
            }
      ...
      if (_text != null) {
        ...
        {
            // cancel any in-flight StartGame
            var lobby = Controller.Get<QuantumMenuUILobby>();
            if (lobby != null) lobby.CancelStartGame();
