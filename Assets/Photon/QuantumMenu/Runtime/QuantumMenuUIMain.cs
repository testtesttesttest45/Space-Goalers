namespace Quantum.Menu {
  ...
  public partial class QuantumMenuUIMain : QuantumMenuUIScreen {
    ...
    [InlineHelp, SerializeField] protected UnityEngine.UI.Button _settingsButton;
     ...
     [InlineHelp, SerializeField] protected UnityEngine.UI.Button _abilitiesButton;
    ...
    public override void Awake() {
      ...
      _quitButton.gameObject.SetActive(false);
            ...
            if (_abilitiesButton != null)
            {
                _abilitiesButton.onClick.RemoveAllListeners();
                _abilitiesButton.onClick.AddListener(OnAbilitiesButtonPressed);
            }
    ...
    protected virtual async void OnPlayButtonPressed() {
      ...
      await Controller.HandleConnectionResult(result, this.Controller);
        ...
        /// <summary> /// Is called when the <see cref="_partyButton"/> is pressed using SendMessage() from the UI object. /// </summary> 
        protected virtual void OnPartyButtonPressed() { Controller.Show<QuantumMenuUIParty>(); }
      ...
      Controller.Show<QuantumMenuUIScenes>();
        ...
        protected virtual void OnAbilitiesButtonPressed()
        {
            Controller.Show<QuantumMenuUIAbilitiesSelection>();
        }
