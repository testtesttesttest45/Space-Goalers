  ...
  public class QuantumStartUIConnection : QuantumStartUIConnectionBase {
    ...
    public override async System.Threading.Tasks.Task ConnectAsync(StartParameter startParameter) {
      ...
      if (startParameter.IsOnline) {
        ...
        Debug.Log($"[QuantumStartUIConnection] Input.MaxCount={Input.MaxCount}  Input.MAX_COUNT={Input.MAX_COUNT}");
      ...
      Debug.Log($"[QuantumStartUIConnection] SessionRunner PlayerCount={sessionRunnerArguments.PlayerCount}");
